...
<body>
	  	<form:form method="POST" action="${pageContext.request.contextPath}/admin/update" modelAttribute="query">
        <div class="container py-4 my-10">
            <div class="card-group">
                <div class="card mx-3 mb-3">
                    <div class="card-header"><i class="fa-solid fa-rotate-right"></i> Zaktualizuj użytkownika(nie wszystkie pola są wymagane)</div>
                    <div class="card-body">
                        <div class="card-text">
                            ...
                            <input class="button" type="submit" value="Zaktualizuj" />
                        </div>
                    </div>
                </div>
            </div>
